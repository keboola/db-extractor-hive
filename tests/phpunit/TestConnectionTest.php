...
class TestConnectionTest extends TestCase
{
    ...
    public function invalidConfigProvider(): array
    {
        return [
            'invalid-host' => [
                'Error connecting to DB: SQLSTATE[HY000] SQLDriverConnect: 1110 [MapR][DriverSupport] (1110) ' .
            ...
            'invalid-database' => [
                'Error connecting to DB: SQLSTATE[HY000] SQLDriverConnect: 101 [MapR][Hardy] (101) ' .
            ...
            'invalid-user' => [
                'Error connecting to DB: SQLSTATE[28000] SQLDriverConnect: 2 [MapR][ThriftExtension] (2) ' .
